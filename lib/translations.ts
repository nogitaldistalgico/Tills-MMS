...
export const translations = {
    en: {
        ...
        guide: {
            ...
            finalStepDesc: "Save these settings as a new printer profile in Bambu Studio. You can then slice as usual (as if you had an AMS). The printer will automatically pause when a color change is needed. You simply need to press 'Unload' and 'Load' on the display and manually change the filament. Since the A1 series comes with a 4-to-1 PTFE adapter installed from the factory, you can load it with 4 filaments to perform the swap quickly and comfortably right at the print head. Unlike the AMS lite, theoretically even more colors are possible.",
    ...
    de: {
        ...
        guide: {
            ...
            finalStepDesc: "Speichere diese Einstellungen als neues Drucker-Profil in Bambu Studio. Danach kannst du wie gewohnt slicen (als hättest du ein AMS). Der Drucker wird automatisch pausieren, wenn ein Farbwechsel ansteht. Du musst dann lediglich am Display 'Unload' und 'Load' drücken und das Filament manuell wechseln. Da die A1 Serie werkseitig einen 4 zu 1 PTFE-Adapter verbaut hat, kann man diesen mit 4 Filamenten beladen, um den Wechsel schnell und komfortabel direkt am Druckkopf durchzuführen. Im Gegensatz zum AMS lite sind aber theoretisch auch noch mehr Farben möglich.",
